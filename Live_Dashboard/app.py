...
def main(count=8000):
	...
	print("NO2: " ,mycc)
	NO2 = mycc
	email = "shradhasehgal21@gmail.com"

	AQI = myaqi
	if(myaqi > 150):
		send_email(email, AQI, PM25, PM10, CO, NO2)
	return render_template('plot.html', myaqi = myaqi)
...
def send_email(email, AQI, PM25, PM10, CO, NO2):
	...
	msg = MIMEMultipart()
	message = message_template.substitute(AQI=AQI, PM25 = PM25, PM10 = PM10, CO = CO, NO2=NO2)
