...
#define SECRET_CH_ID1 905895      // replace 0000000 with your channel number
#define SECRET_WRITE_APIKEY1 "AH72Y9F6D2ND0EZI"   // replace XYZ with your channel write API Key

#define SECRET_CH_ID2 905904      // replace 0000000 with your channel number
#define SECRET_WRITE_APIKEY2 "63NM4RD0GST5WFO8"   // replace XYZ with your channel write API Key

#define SECRET_CH_ID3 905893      // replace 0000000 with your channel number
#define SECRET_WRITE_APIKEY3 "R300CE5W9MVAHGNT"   // replace XYZ with your channel write API Key

#define SECRET_CH_ID4 905902      // replace 0000000 with your channel number
#define SECRET_WRITE_APIKEY4 "M6E46LE1II7ILFDS"   // replace XYZ with your channel write API Key
int rxPin = D7;
int txPin = D8;
...
void loop() {
  ...
  */
  ...
  createCI("Team10_Indoor_air_pollution_Mobile", "node_2", sensor_value_string);
